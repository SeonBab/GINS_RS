...
protected:
	/** 항상 보이는 구조물 본체이며 감지 영역과 충전 표시의 배치 기준입니다 */
...
private:
	...
	/**
	 * 충전을 채우고 그 순간 영역 안에 있는 대상을 바로 회복시킵니다
	...
	/** 살아 있고 체력이 최대가 아닌 대상인지 반환합니다 */
	static bool NeedsHealing(const ARSPlayerCharacter* PlayerCharacter);
