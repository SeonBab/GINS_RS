...
namespace RSGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Ability_Combat_FireballSpread, "Ability.Combat.FireballSpread", "보스 화염구 살포 특수 패턴 Ability를 식별합니다");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Ability_Combat_FireFieldDamage, "Ability.Combat.FireFieldDamage", "화염구 장판의 1회 피해 Ability를 식별합니다");
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(GameplayEvent_Combat_FireFieldDamage, "GameplayEvent.Combat.FireFieldDamage", "화염구 장판이 찾은 플레이어에게 1회 피해를 적용하도록 화염구 ASC에 알립니다");
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(State_Hazard_Fireball_Vulnerable, "State.Hazard.Fireball.Vulnerable", "착지 후 충전 중인 화염구가 플레이어의 개별 타격을 받을 수 있음을 나타냅니다");
